...
import {createCoughDetectionCheck, createNoisyCoughCheck, createCoughValidationCheck, createVoiceEmbedding} from '../../controllers/hardwareController';
...
router.post(`/public/voice/embedding`, [fileUploaderMiddleware], createVoiceEmbedding);
