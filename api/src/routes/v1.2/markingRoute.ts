...
import {getMarkingRecords, getAudioGeneralInfo, getCoughDetailedInfo,
    ...
    putAudioEpisodes, getNavigationById, deleteMarkingRecord} from '../../controllers/markingController';
...
router.delete(`/${ADMIN_ROUTE}/${ROUTE_NAME}/:id`, BASIC_MIDDLEWARES, deleteMarkingRecord);
