...
router.delete(`/${ADMIN_ROUTE}/${USER_ROUTE}/:id`, BASIC_MIDDLEWARES, controller.deleteUser.bind(controller));
...
router.delete(`/${ADMIN_ROUTE}/${USER_ROUTE}/:id/data`, BASIC_MIDDLEWARES, controller.dischargePersonalData.bind(controller));
